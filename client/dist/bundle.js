...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _messageDisplay = __webpack_require__(209);

	var _messageDisplay2 = _interopRequireDefault(_messageDisplay);

	var _messageInput = __webpack_require__(210);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.receiveConn.onopen = function () {
	        return console.log('Receive Connected!');
	      };
	      this.sendConn = new WebSocket('ws://localhost:8090/ws');
	      this.sendConn.onopen = function () {
	        return console.log('Send Connected!');
	      };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_messageDisplay2.default, { messages: this.state.messages }),
	            _react2.default.createElement(_messageInput2.default, { onSend: this.sendMessage.bind(this) })
	          )
	        )
	      );
	    }
	...
	var MessageInput = function (_Component) {
	  ...
	  _createClass(MessageInput, [{
	    ...
	    value: function showMessages() {
	      return this.props.messages.map(function (msg, index) {
	        return _react2.default.createElement(
	          'p',
	          { key: index },
	          msg
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-md-12 msg-display' },
	          _react2.default.createElement(
	            'div',
	            { className: 'well' },
	            this.showMessages()
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'button',
	                { onClick: this.handleSubmit, className: 'btn btn-success', type: 'button' },
